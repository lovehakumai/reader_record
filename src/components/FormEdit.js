...
export default function FormEdit({ src: { id, read, memo } }) {
    ...
    return (
        <form action={addReview}>
            ...
            <button type="submit" className="bg-blue-600 text-white rounded px-4 py-2 mr-2 hover:bg-blue-500">
                登録
            </button>
            <button type="submit" className="bg-red-600 text-white rounded px-4 py-2 hover:bg-red-500" formAction={removeReview}>
                削除
            </button>
        </form>
);
